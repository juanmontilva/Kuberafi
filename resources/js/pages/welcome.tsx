                    ...
                    <nav className="flex items-center justify-end gap-4">
                        {auth.user ? (
                            ...
                            <>
                                ...
                                <span className="inline-block rounded-sm border border-[#19140035] px-5 py-1.5 text-sm leading-normal text-gray-400 dark:border-[#3E3E3A] dark:text-gray-500 cursor-not-allowed">
